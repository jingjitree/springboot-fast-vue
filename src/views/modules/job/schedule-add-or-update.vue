        ...
        this.$nextTick(() => {
          ...
          if (this.dataForm.id) {
            this.$http({
              ...
              if (data && data.code === 1) {
                this.dataForm.beanName = data.data.schedule.beanName
                this.dataForm.params = data.data.schedule.params
                this.dataForm.cronExpression = data.data.schedule.cronExpression
                this.dataForm.remark = data.data.schedule.remark
                this.dataForm.status = data.data.schedule.status
              }
            })
          }
        })
